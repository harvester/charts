...
*/}}
{{- define "upgrade-toolkit.fullname" -}}
...
*/}}
{{- define "upgrade-toolkit.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "upgrade-toolkit.resourceName" -}}
{{- $fullname := include "upgrade-toolkit.fullname" .context }}
{{- $suffix := .suffix }}
